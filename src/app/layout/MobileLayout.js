...
import { StrategyBuilderSidebarIcon } from "../../assets/images/icons";
...
import "../Portfolio/_mobilePortfolio.scss";
import SmartMoneyMobileSignOutModal from "../common/smartMoneyMobileSignOutModal";
...
class MobileLayout extends BaseReactComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      navItems: [
        {
          pageIcon: StrategyBuilderSidebarIcon,
          text: "Builder",
          path: "/home",
        },
        {
